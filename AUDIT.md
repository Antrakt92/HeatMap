...
1. Добавить user-visible UI status для LHM/config failures и удобный доступ к log file path.
2. Расширить fake LHM tests на GPU/VRAM/fan parsing и варианты sensor names.
